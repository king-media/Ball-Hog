        ...
        if (value !== null && value !== void 0) {
          if (typeof value === "object") {
            if (propToStyleFunction2[styleKey]) {
              css3 = merge_default(css3, getThemeValue(styleKey, value, theme));
            } else {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box_default, {
        ...
        children: liveGames.map((game, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
          children: Math.abs(activeStep - index) <= 5 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card_default, {
            sx: { minWidth: 300, padding: "0 1em" },
            children: [
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-JHVRJY32.js.map
