...
var ArrowButtonPrimitive = (direction) => styled_default(
  Button_default
)`
    position: absolute,
    top: 50%,
...
var MaterialArrowButton = (0, import_react.forwardRef)(
  ({ onClick, direction, ...props }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ArrowButtonPrimitive, {
    direction,
    size: "small",
    variant: "text",
    onClick: () => onClick(),
...
//# sourceMappingURL=/build/routes/index-NQI7QKV3.js.map
