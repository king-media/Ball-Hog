...
var MaterialRightArrow = ({ onClick, ...rest }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, {
    size: "small",
    sx: { position: "absolute", top: "50%", right: 0, borderRadius: "999px" },
    variant: "text",
    onClick: () => onClick(),
...
var MaterialLeftArrow = ({ onClick, ...rest }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, {
    size: "small",
    sx: { position: "absolute", top: "50%", left: 0, borderRadius: "999px" },
    onClick: () => onClick(),
...
//# sourceMappingURL=/build/routes/index-C4JLLKLB.js.map
