...
var ScheduledGamesTitle = () => {
  ...
  const [dates, setDates] = (0, import_react4.useState)({
    startDate: search.get("startDate") || (0, import_moment3.default)().format("YYYY-MM-DD"),
    endDate: search.get("endDate") || (0, import_moment3.default)().add(1, "week").format("YYYY-MM-DD")
  });
...
//! momentjs.com
//! version : 2.29.4
//# sourceMappingURL=/build/routes/index-STRAIYB7.js.map
