...
var require_emotion_react_jsx_dev_runtime_cjs_dev = __commonJS({
  "node_modules/@emotion/react/jsx-dev-runtime/dist/emotion-react-jsx-dev-runtime.cjs.dev.js"(exports) {
    ...
    function jsxDEV5(type, props, key, isStaticChildren, source, self) {
...
var ScheduledGamesTitle = () => {
  ...
  const [dates, setDates] = (0, import_react3.useState)({
    startDate: search.get("startDate") || (0, import_moment3.default)().format(dateFormat),
    endDate: search.get("endDate") || (0, import_moment3.default)().add(1, "week").format(dateFormat)
  });
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box_default, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DatePicker, {
              ...
              onChange: (value) => {
                const selectedDate = (0, import_moment3.default)(String(value)).format(dateFormat);
...
//! momentjs.com
//! version : 2.29.4
//# sourceMappingURL=/build/routes/index-RFS4FH47.js.map
