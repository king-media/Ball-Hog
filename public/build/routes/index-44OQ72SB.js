...
var Typography = /* @__PURE__ */ React7.forwardRef(function Typography2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_m_default(classes.root, className)
...
function CardCarousel({
  ...
  const handleStepChange = (step) => {
    const totalSlides = totalItems / show;
    setActiveStep(100 * step / totalSlides);
  };
 ...
 */
//# sourceMappingURL=/build/routes/index-44OQ72SB.js.map
