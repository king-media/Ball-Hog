...
function Home() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box_default, {
    sx: { maxWidth: 760, flexGrow: 1 },
    children: [
      liveGames.map((game, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        children: Math.abs(activeStep - index) <= 2 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card_default, {
          sx: { minWidth: 300, display: "flex", flexDirection: "row" },
          children: [
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-VD74HDWO.js.map
